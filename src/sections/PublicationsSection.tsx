    ...
    >
      <div className="space-y-6 grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="card interactive-card w-full">
          <h3 className="section-title text-xl mb-4 flex items-center gap-2"><FaBook className="icon-primary" size={24} /> A Design of Crowd-Based Corruption Prevention System in Indonesia</h3>
        ...
        <div className="card interactive-card w-full">
          <h3 className="section-title text-xl mb-4 flex items-center gap-2"><FaBook className="icon-primary" size={24} /> Systematic literature review on corruption prevention efforts towards sustainable economy in Indonesia</h3>
        ...
        <div className="card interactive-card w-full">
          <h3 className="section-title text-xl mb-4 flex items-center gap-2"><FaBook className="icon-primary" size={24} /> Development of a Web Based Corruption Case Mapping Using Machine Learning with Artificial Neural Network</h3>
        ...
        <div className="card interactive-card w-full">
          <h3 className="section-title text-xl mb-4 flex items-center gap-2"><FaBook className="icon-primary" size={24} /> Indonesian teacher engagement index (ITEI): Decision support system for education</h3>
        ...
        <div className="card interactive-card w-full">
          <h3 className="section-title text-xl mb-4 flex items-center gap-2"><FaBook className="icon-primary" size={24} /> Corruption Cases Mapping Based on Indonesia&apos;s Corruption Perception Index</h3>
        ...
        <div className="card interactive-card w-full">
          <h3 className="section-title text-xl mb-4 flex items-center gap-2"><FaBook className="icon-primary" size={24} /> Corruption Early Prevention: Decision Support System for President of the Republic of Indonesia</h3>
          <p className="mb-4">Journal of Physics: Conference Series · Jan 1, 2017</p>
